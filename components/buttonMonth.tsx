...
function ButtonMonth() {
    ...
    return (
        ...
        >
            ...
            <span
                className='tracking-[2.2px] bg-clip-text text-transparent bg-gradient-to-b from-white from-50% to-transparent to-100% font-bold z-10 text-[10px] mt-[18px]'>
                2023
            </span>
        </div>
    );
